            ...
            <MDBNavbar transparent className="z-depth-0" color="white" expand="md" fixed="top" style={{ fontColor:'black' }}>
                ...
                <MDBCollapse id="navbarCollapse3" isOpen={isOpen} navbar>
                    <MDBNavbarNav left>
                        ...
                        <MDBNavItem active>
                            <a><MDBNavbarBrand><Link href="/projects"><strong style={{ color: "#000000" }}>Projects</strong></Link></MDBNavbarBrand></a>
                        </MDBNavItem>
                        <MDBNavItem active>
                            <a><MDBNavbarBrand><Link href="/create"><strong style={{ color: "#000000" }}>Create</strong></Link></MDBNavbarBrand></a>
                        </MDBNavItem>
                        {/* <MDBNavItem>
